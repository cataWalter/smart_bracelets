...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b6a458, const void *arg_0xb7b6a5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b1b8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79c5840), 
int (*key_eq_fn)(void *arg_0xb79c5c88, void *arg_0xb79c5e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78949b8, int arg_0xb7894b10);
static double RandomUniform(void );
...
typedef TMilli SmartBraceletC$TimerStatus$precision_tag;
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SmartBraceletC$sendFound$runTask(void );
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void SmartBraceletC$Boot$booted(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SmartBraceletC$sendStatus$runTask(void );
...
static void SmartBraceletC$TimerStatus$fired(void );
#line 83
static void SmartBraceletC$TimerPairing$fired(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SmartBraceletC$sendPairing$runTask(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SmartBraceletC$sendFound$postTask(void );
#line 67
static error_t SmartBraceletC$sendStatus$postTask(void );
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$TimerStatus$startPeriodic(uint32_t dt);
...
static void SmartBraceletC$TimerStatus$startOneShot(uint32_t dt);




static void SmartBraceletC$TimerStatus$stop(void );
#line 64
static void SmartBraceletC$TimerPairing$startPeriodic(uint32_t dt);
#line 78
static void SmartBraceletC$TimerPairing$stop(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SmartBraceletC$sendPairing$postTask(void );
# 49 "SmartBraceletC.nc"
enum SmartBraceletC$__nesc_unnamed4332 {
#line 49
  SmartBraceletC$sendFound = 3U
};
#line 49
typedef int SmartBraceletC$__nesc_sillytask_sendFound[SmartBraceletC$sendFound];
enum SmartBraceletC$__nesc_unnamed4333 {
#line 50
  SmartBraceletC$sendPairing = 4U
};
#line 50
typedef int SmartBraceletC$__nesc_sillytask_sendPairing[SmartBraceletC$sendPairing];
enum SmartBraceletC$__nesc_unnamed4334 {
#line 51
  SmartBraceletC$sendStatus = 5U
};
#line 51
typedef int SmartBraceletC$__nesc_sillytask_sendStatus[SmartBraceletC$sendStatus];
#line 40
uint8_t SmartBraceletC$key[1000][20];
message_t SmartBraceletC$packet[1000];
uint16_t SmartBraceletC$paired_addr[1000];
bool SmartBraceletC$isChild[1000];
bool SmartBraceletC$pairing[1000];
int SmartBraceletC$i[1000];
uint8_t SmartBraceletC$last_x[1000];
uint8_t SmartBraceletC$last_y[1000];
...
static void SmartBraceletC$AMSend$sendDone(message_t *buf, error_t error);
...
#line 147
static inline void SmartBraceletC$TimerStatus$fired(void );





static inline void SmartBraceletC$sendFound$runTask(void );
...
static inline void SmartBraceletC$sendPairing$runTask(void );
...
static inline void SmartBraceletC$sendStatus$runTask(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$TimerStatus$startOneShot(uint32_t dt){
#line 73
...
inline static void SmartBraceletC$TimerStatus$stop(void ){
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$TimerStatus$startPeriodic(uint32_t dt){
#line 64
...
#line 78
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SmartBraceletC$sendFound$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBraceletC$sendFound);
#line 67
...
#line 104
  sim_log_debug(154U, "Radio", "Received message of type %d from source %d\n", __nesc_ntoh_uint8(dat->type.nxdata), __nesc_ntoh_uint16(dat->source.nxdata));


  if (__nesc_ntoh_uint16(dat->dest.nxdata) == TOS_NODE_ID || __nesc_ntoh_uint16(dat->dest.nxdata) == 101) {
      if (__nesc_ntoh_uint8(dat->type.nxdata) == 1) {

          for (SmartBraceletC$i[sim_node()] = 0; SmartBraceletC$i[sim_node()] < 20; SmartBraceletC$i[sim_node()]++) if (__nesc_ntoh_uint8(dat->key[SmartBraceletC$i[sim_node()]].nxdata) != SmartBraceletC$key[sim_node()][SmartBraceletC$i[sim_node()]]) {
                sim_log_debug(155U, "Radio", "...message discarded\n");
                return msg;
              }

          SmartBraceletC$paired_addr[sim_node()] = __nesc_ntoh_uint16(dat->source.nxdata);
          SmartBraceletC$sendFound$postTask();
        }
      else {
#line 118
        if (__nesc_ntoh_uint8(dat->type.nxdata) == 3 && SmartBraceletC$pairing[sim_node()]) {

            for (SmartBraceletC$i[sim_node()] = 0; SmartBraceletC$i[sim_node()] < 20; SmartBraceletC$i[sim_node()]++) if (__nesc_ntoh_uint8(dat->key[SmartBraceletC$i[sim_node()]].nxdata) != SmartBraceletC$key[sim_node()][SmartBraceletC$i[sim_node()]]) {
                  sim_log_debug(156U, "Radio", "...message discarded\n");
                  return msg;
                }

            sim_log_debug(157U, "Pairing", "Pairing stopped on FOUND received\n");
            SmartBraceletC$pairing[sim_node()] = 0;
            SmartBraceletC$TimerPairing$stop();
            if (SmartBraceletC$isChild[sim_node()]) {
#line 128
              SmartBraceletC$TimerStatus$startPeriodic(10000);
              }
            else {
#line 130
              SmartBraceletC$TimerStatus$startOneShot(60000);
              }
          }
        else {
#line 132
          if (__nesc_ntoh_uint8(dat->type.nxdata) == 2) {

              sim_log_debug(158U, "Radio", "Status Received %d @ %d,%d\n", __nesc_ntoh_uint8(dat->status.nxdata), __nesc_ntoh_uint8(dat->x.nxdata), __nesc_ntoh_uint8(dat->y.nxdata));
              SmartBraceletC$TimerStatus$stop();
              SmartBraceletC$TimerStatus$startOneShot(60000);
              SmartBraceletC$last_x[sim_node()] = __nesc_ntoh_uint8(dat->x.nxdata);
              SmartBraceletC$last_y[sim_node()] = __nesc_ntoh_uint8(dat->y.nxdata);
              if (__nesc_ntoh_uint8(dat->status.nxdata) == 8) {
#line 139
                sim_log_debug(159U, "ALARM", "! - FALLING - ! @%d,%d\n", __nesc_ntoh_uint8(dat->x.nxdata), __nesc_ntoh_uint8(dat->y.nxdata));
                }
            }
          }
        }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7637ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7637ac8) {
#line 78
    case 8:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7637ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7635178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7635178, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(151U, "Radio", "Node's Radio ready\n");
      sim_log_debug(152U, "Pairing", "Pairing phase started\n");

      SmartBraceletC$pairing[sim_node()] = 1;
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7637108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7637108, msg, error);
#line 110
}
#line 110
...
#line 126
# 153 "SmartBraceletC.nc"
static inline void SmartBraceletC$sendFound$runTask(void )
#line 153
{
  msggtype *msgg = (msggtype *)SmartBraceletC$Packet$getPayload(&SmartBraceletC$packet[sim_node()], sizeof(msggtype ));

#line 155
  for (SmartBraceletC$i[sim_node()] = 0; SmartBraceletC$i[sim_node()] < 20; SmartBraceletC$i[sim_node()]++) __nesc_hton_uint8(msgg->key[SmartBraceletC$i[sim_node()]].nxdata, SmartBraceletC$key[sim_node()][SmartBraceletC$i[sim_node()]]);
  __nesc_hton_uint16(msgg->source.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(msgg->dest.nxdata, SmartBraceletC$paired_addr[sim_node()]);
  __nesc_hton_uint8(msgg->type.nxdata, 3);
  sim_log_debug(161U, "Pairing", "sending FOUND to %d\n", __nesc_ntoh_uint16(msgg->dest.nxdata));
  SmartBraceletC$AMSend$send(SmartBraceletC$paired_addr[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(msggtype ));
}
...
#line 166
  for (SmartBraceletC$i[sim_node()] = 0; SmartBraceletC$i[sim_node()] < 20; SmartBraceletC$i[sim_node()]++) __nesc_hton_uint8(msgg->key[SmartBraceletC$i[sim_node()]].nxdata, SmartBraceletC$key[sim_node()][SmartBraceletC$i[sim_node()]]);
  __nesc_hton_uint16(msgg->source.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(msgg->dest.nxdata, 101);
  __nesc_hton_uint8(msgg->type.nxdata, 1);
  sim_log_debug(162U, "Pairing", "sending Pairing broadcast request\n");
  SmartBraceletC$AMSend$send(AM_BROADCAST_ADDR, &SmartBraceletC$packet[sim_node()], sizeof(msggtype ));
}
...
#line 177
  ...
  __nesc_hton_uint16(msgg->source.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(msgg->dest.nxdata, SmartBraceletC$paired_addr[sim_node()]);
  __nesc_hton_uint8(msgg->type.nxdata, 2);

  SmartBraceletC$i[sim_node()] = rand() % 10;

  if (SmartBraceletC$i[sim_node()] < 3) {
#line 184
    __nesc_hton_uint8(msgg->status.nxdata, 5);
    }
  else {
#line 185
    if (SmartBraceletC$i[sim_node()] < 6) {
#line 185
      __nesc_hton_uint8(msgg->status.nxdata, 6);
      }
    else {
#line 186
      if (SmartBraceletC$i[sim_node()] < 9) {
#line 186
        __nesc_hton_uint8(msgg->status.nxdata, 7);
        }
      else {
#line 187
        __nesc_hton_uint8(msgg->status.nxdata, 8);
        }
      }
    }
#line 189
  __nesc_hton_uint8(msgg->x.nxdata, rand() % 100);
  __nesc_hton_uint8(msgg->y.nxdata, rand() % 100);

  sim_log_debug(163U, "Radio", "Status: %d, x:%d y:%d\n", __nesc_ntoh_uint8(msgg->status.nxdata), __nesc_ntoh_uint8(msgg->x.nxdata), __nesc_ntoh_uint8(msgg->y.nxdata));
  SmartBraceletC$AMSend$send(SmartBraceletC$paired_addr[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(msggtype ));
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74c3010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74c3010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74c3010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77f0650){
#line 75
  switch (arg_0xb77f0650) {
#line 75
...
#line 75
      break;
#line 75
    case SmartBraceletC$sendFound:
#line 75
      SmartBraceletC$sendFound$runTask();
#line 75
      break;
#line 75
    case SmartBraceletC$sendPairing:
#line 75
      SmartBraceletC$sendPairing$runTask();
#line 75
      break;
#line 75
    case SmartBraceletC$sendStatus:
#line 75
      SmartBraceletC$sendStatus$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77f0650);
#line 75
      break;
#line 75
    }
...
#line 75
#line 67
inline static error_t SmartBraceletC$sendPairing$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBraceletC$sendPairing);
#line 67
...
#line 67
# 88 "SmartBraceletC.nc"
static inline void SmartBraceletC$TimerPairing$fired(void )
#line 88
{
  SmartBraceletC$sendPairing$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SmartBraceletC$sendStatus$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBraceletC$sendStatus);
#line 67
...
#line 147
{
  if (SmartBraceletC$isChild[sim_node()]) {
#line 148
    SmartBraceletC$sendStatus$postTask();
    }
  else {
#line 149
    sim_log_debug(160U, "ALARM", "! - MISSING - ! --------- last found @%d,%d\n", SmartBraceletC$last_x[sim_node()], SmartBraceletC$last_y[sim_node()]);
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7346c70){
#line 83
  switch (arg_0xb7346c70) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 1U:
#line 83
      SmartBraceletC$TimerStatus$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7346c70);
#line 83
      break;
#line 83
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74c39f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74c39f8, addr, msg, len);
#line 80
...
#line 55
{
  ...
  srand(time((void *)0) * TOS_NODE_ID);


  if (TOS_NODE_ID < 3) {
#line 61
    for (SmartBraceletC$i[sim_node()] = 0; SmartBraceletC$i[sim_node()] < 20; SmartBraceletC$i[sim_node()]++) SmartBraceletC$key[sim_node()][SmartBraceletC$i[sim_node()]] = "AAAAABBBBBCCCCCDDDDD"[SmartBraceletC$i[sim_node()]];
    }
  else {
#line 62
    for (SmartBraceletC$i[sim_node()] = 0; SmartBraceletC$i[sim_node()] < 20; SmartBraceletC$i[sim_node()]++) SmartBraceletC$key[sim_node()][SmartBraceletC$i[sim_node()]] = "EEEEEFFFFFGGGGGHHHHH"[SmartBraceletC$i[sim_node()]];
    }
#line 63
  if (TOS_NODE_ID % 2 == 1) {
#line 63
    SmartBraceletC$isChild[sim_node()] = 1;
    }
#line 64
  sim_log_debug(148U, "Boot", "Started node %u with key ", TOS_NODE_ID);
  for (SmartBraceletC$i[sim_node()] = 0; SmartBraceletC$i[sim_node()] < 20; SmartBraceletC$i[sim_node()]++) sim_log_debug_clear(149U, "Boot", "%c", SmartBraceletC$key[sim_node()][SmartBraceletC$i[sim_node()]]);
  sim_log_debug_clear(150U, "Boot", ".\n");
  SmartBraceletC$AMControl$start();
}
...
# 93 "SmartBraceletC.nc"
static void SmartBraceletC$AMSend$sendDone(message_t *buf, error_t error)
#line 93
{
  if (&SmartBraceletC$packet[sim_node()] == buf && error == SUCCESS) {
    }
  else {
      sim_log_error(153U, "Radio", "Error in sending\n");
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SmartBraceletC$paired_addr"))
  {
    *addr = (uintptr_t)&SmartBraceletC$paired_addr[__nesc_mote];
    *size = sizeof(SmartBraceletC$paired_addr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$isChild"))
  {
    *addr = (uintptr_t)&SmartBraceletC$isChild[__nesc_mote];
    *size = sizeof(SmartBraceletC$isChild[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$pairing"))
  {
    *addr = (uintptr_t)&SmartBraceletC$pairing[__nesc_mote];
    *size = sizeof(SmartBraceletC$pairing[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$i"))
  {
    *addr = (uintptr_t)&SmartBraceletC$i[__nesc_mote];
    *size = sizeof(SmartBraceletC$i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$last_x"))
  {
    *addr = (uintptr_t)&SmartBraceletC$last_x[__nesc_mote];
    *size = sizeof(SmartBraceletC$last_x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$last_y"))
  {
    *addr = (uintptr_t)&SmartBraceletC$last_y[__nesc_mote];
    *size = sizeof(SmartBraceletC$last_y[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  SmartBraceletC$paired_addr[__nesc_mote] = -1;
  SmartBraceletC$isChild[__nesc_mote] = 0;
  SmartBraceletC$pairing[__nesc_mote] = 0;
  memset((void *)&SmartBraceletC$i[__nesc_mote], 0, sizeof SmartBraceletC$i[__nesc_mote]);
  SmartBraceletC$last_x[__nesc_mote] = -1;
  SmartBraceletC$last_y[__nesc_mote] = -1;
